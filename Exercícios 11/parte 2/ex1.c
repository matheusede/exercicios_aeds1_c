...
//Função para visualizar a venda de um vendedor em um determinado mês
...
//Função para listar o total de vendas de um vendedor
...
//Função para retornar vendedor com mais vendas
...
//funçaõ para retornar o mês com mais vendas
...
int main(void)
{
    ...
    while (menu != 7)
    {
        ...
        {
        case 1:
            cadastraVendedor(nVendedores, vendedores); //Menu para cadastrar vendedor
            break;
        case 2:
            printf("Insira o códgio do vendedor.\n"); //Opção para cadastrar vendas
            scanf("%f", &idV);
        ...
        case 3:
            ...
            break;
        case 4:
            printf("Insira o códgio do vendedor.\n"); //Função para visualizar o total de vendas de um funcionário
            scanf("%f", &idV);
